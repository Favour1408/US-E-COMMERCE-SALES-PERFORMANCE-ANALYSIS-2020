...
- How did shipping methods affect operational costs?
...
Before analysis, the dataset was checked to ensure it was consistent and ready for reporting. Minimal preparation was required since the dataset was already clean.
...
The `Year` column was calculated using:

```excel
=TEXT([@[Order Date]],"YYYY")

Absolutely! Your content is already very close to Markdown, but I’ll **polish it into a clean, fully Markdown-ready `README.md` format**, ready to paste directly into GitHub. I’ll also ensure headings, lists, code blocks, and links are properly formatted.
...
An interactive Excel dashboard was created to allow users to explore the dataset dynamically.
...
* **Same Day** shipping recorded the highest losses despite strong sales volume.
* **Second Class** shipping also contributed to negative profit.

Fast delivery options significantly increased fulfillment costs and reduced margins.

### Customer Segment Performance

* The **Corporate** segment generated the highest sales but also recorded the largest loss, indicating heavy discounting and pricing concessions.
...
* The **Central** and **West** regions performed positively.
* The **East** region showed minimal profit contribution.
...
* Apply discount limits to high-cost items
* Introduce margin-based discount rules
* Reduce blanket promotional discounts
...
* Review negotiated pricing agreements
* Reduce excessive bulk discounts
* Set minimum profit thresholds for large orders

### Improve Regional Cost Management

Losses in the South region indicate structural cost issues.
* Review logistics and shipping costs in the region
